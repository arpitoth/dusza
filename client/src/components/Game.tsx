              ...
              <form>
                <DialogContent className="bg-gradient-to-br from-gray-800 to-gray-700 rounded-2xl shadow-2xl p-8 text-white border-none">
                  ...
                  <div className="grid gap-4">
                    ...
                    <div className="grid gap-3">
                      <Label htmlFor="username-1">Sebzés</Label>
                      <Input
                        type="number"
                        id="damage-1"
                        name="damage"
                    ...
                    <div className="grid gap-3">
                      <Label htmlFor="username-1">Életerő</Label>
                      <Input
                        type="number"
                        id="health-1"
                        name="health"
                    ...
                    <div className="grid gap-3">
                      ...
                      >
                        <SelectTrigger id="dropdown" className="w-full rounded-lg bg-gray-800 border border-gray-700 px-3 py-2 text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 border-none cursor-pointer">
                          <SelectValue placeholder="Válassz..." />
                        </SelectTrigger>
                        <SelectContent className="bg-gray-800 border border-gray-700 text-white">
                          <SelectItem className="cursor-pointer" value="Tűz">Tűz</SelectItem>
                          <SelectItem className="cursor-pointer" value="Víz">Víz</SelectItem>
                          <SelectItem className="cursor-pointer" value="Levegő">Levegő</SelectItem>
                          <SelectItem className="cursor-pointer" value="Föld">Föld</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                  </div>
                  <DialogFooter>
                    <DialogClose asChild>
                      <Button className="text-white cursor-pointer bg-indigo-600 hover:bg-indigo-500">
                        Cancel
                      </Button>
                    </DialogClose>
                    <Button
